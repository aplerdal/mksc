...
sub_8033A5C:
    ...
    .byte 0x1F, 0x00
    thumb_func_start sub_8033BAC
sub_8033BAC:
    ldr r1, _08033BB8 @ =0x080E7464
    lsls r0, r0, #0x02
    adds r0, r0, r1
    ldr r0, [r0, #0x00]
    bx lr
    .byte 0x00, 0x00
_08033BB8: .4byte 0x080E7464
    thumb_func_start sub_8033BBC
sub_8033BBC:
    ldr r1, _08033BC8 @ =0x080E74C4
    lsls r0, r0, #0x02
    adds r0, r0, r1
    ldr r0, [r0, #0x00]
    bx lr
    .byte 0x00, 0x00
_08033BC8: .4byte 0x080E74C4
    .byte 0x02, 0x49, 0x80, 0x00, 0x40, 0x18, 0x00, 0x68, 0x70, 0x47, 0x00, 0x00, 0x14, 0x75, 0x0E, 0x08
    thumb_func_start sub_8033BDC
sub_8033BDC:
    ldr r1, _08033BE8 @ =0x080E7524
    lsls r0, r0, #0x02
    adds r0, r0, r1
    ldr r0, [r0, #0x00]
    bx lr
    .byte 0x00, 0x00
_08033BE8: .4byte 0x080E7524
    thumb_func_start sub_8033BEC
sub_8033BEC:
    lsls r0, r0, #0x18
    lsrs r0, r0, #0x18
    cmp r0, #0x1F
...
_08033C20:
    ...
    bls _08033C14
    b _08033C4A
_08033C2C: .4byte 0x080E7464
_08033C30:
    movs r1, #0x00
    ldr r4, _08033C54 @ =0x080E74C4
_08033C34:
    lsls r0, r1, #0x02
    adds r0, r0, r4
    ldr r0, [r0, #0x00]
...
_08033C7C:
    ...
    bls _08033C70
    b _08033CA6
_08033C88: .4byte 0x080E7464
_08033C8C:
    movs r1, #0x00
    ldr r4, _08033CB0 @ =0x080E74C4
_08033C90:
    lsls r0, r1, #0x02
    adds r0, r0, r4
    ldr r0, [r0, #0x00]
