...
# This looks for Unknown_, Unknown_, sub_, or FUN_, followed by an address. Note that
# it matches even if stuff precedes the unknown, like sUnknown/gUnknown.
my $undoc_regex = "'[Uu]nknown_[0-9a-fA-F]\\{5,7\\}\\|sub_[0-9a-fA-F]\\{5,7\\}\\|FUN_[0-9a-fA-F]\\{5,7\\}'";
